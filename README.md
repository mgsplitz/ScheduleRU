...
apps/api/src/programs/             Program policy, evidence, presentation, and import helpers
apps/api/src/schedule-assistant.js Bounded OpenAI schedule-preference adapter
...
worker/src/schedule-assistant.js   Temporary compatibility export for older tools
worker/src/program-*.js            Temporary compatibility exports for older tools
